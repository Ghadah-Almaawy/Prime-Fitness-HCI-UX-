...
3. **Prototyping** — built interactive mockups for every screen in the flow (see screenshots below and the full Figma link above).
...
- **Workout Module** — live or recorded sessions, filtered by difficulty (Beginner/Intermediate/Advanced) and type (Cardio/Strength/Flexibility), with trainer selection
- **Subscription Module** — Free and Premium ($99/year) plans, payment via Apple Pay/PayPal/Credit Card, plan management (upgrade/downgrade/cancel)
- **Fitness Tracker Module** — visual charts for steps, activity, and goal progress
...
| Task | Finding | Suggestion |
|---|---|---|
| Choosing a workout plan | One user unsure which plan to pick | Add a short quiz to recommend a plan |
| Finding the fitness tracker | One user had difficulty locating it | Highlight the tracker on the homepage |
| Payment process | One user noted no confirmation step | Add SMS verification + option to save payment details |
| Selecting an instructor | Confusion on first use | Add guidance for choosing an instructor |
...
- **Link goals to stats** — connect fitness goals directly to progress tracking
